...
6. **Ambiguity Rule:** If the title and description contradict each other, lack clarity, or provide insufficient detail, select genre `"other"`, audience `"general"`, confidence below `0.5`, and `needs_review: true`.
